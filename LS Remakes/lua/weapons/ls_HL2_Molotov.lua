...
hook.Add("Initialize", "OCAmmoMolotov", function()
	game.AddAmmoType({
		name = "molotov"
	})
end)
...
SWEP.Projectile = {}
SWEP.Projectile.Model = "models/props_junk/glassbottle01a.mdl"
SWEP.Projectile.FireSound = "physics/glass/glass_bottle_break2.wav"
SWEP.Projectile.HitSound = "physics/glass/glass_bottle_break2.wav"
...
function SWEP:ProjectileFire()
	...
	timer.Simple(0.2, function()
		...
		for i = 1, 23 do
			...
			molotovfire:SetKeyValue("firesize", "60")
			molotovfire:SetKeyValue("damagescale", "8")
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetVec = Vector(3.8, -2, -2)
